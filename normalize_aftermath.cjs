const fs = require('fs');
const path = 'C:\\\\Users\\\\Windows 10 21H1\\\\.gemini\\\\antigravity\\\\scratch\\\\trandhquan-personal-library\\\\src\\\\pages\\\\buffett_aftermath.js';
...
console.log('Normalized aftermath');
