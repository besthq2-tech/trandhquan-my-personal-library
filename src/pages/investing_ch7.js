const investingCh7Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Optimal Risky Portfolios</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh7HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 7: Optimal Risky Portfolios</span></div>
...
export default investingCh7HTML;
export { investingCh7Pages };
