const investingCh28Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Investment Policy and the Framework of the CFA Institute</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh28HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 28: Investment Policy and the Framework of the CFA Institute</span></div>
...
export default investingCh28HTML;
export { investingCh28Pages };
