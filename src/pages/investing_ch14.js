const investingCh14Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Bond Prices and Yields</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh14HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 14: Bond Prices and Yields</span></div>
...
export default investingCh14HTML;
export { investingCh14Pages };
