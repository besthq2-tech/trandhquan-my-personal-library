const investingCh25Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 International Diversification</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh25HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 25: International Diversification</span></div>
...
export default investingCh25HTML;
export { investingCh25Pages };
