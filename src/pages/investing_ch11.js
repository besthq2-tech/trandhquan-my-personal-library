const investingCh11Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 The Efficient Market Hypothesis</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh11HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 11: The Efficient Market Hypothesis</span></div>
...
export default investingCh11HTML;
export { investingCh11Pages };
