const investingCh12Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Behavioral Finance and Technical Analysis</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh12HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 12: Behavioral Finance and Technical Analysis</span></div>
...
export default investingCh12HTML;
export { investingCh12Pages };
