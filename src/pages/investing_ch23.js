const investingCh23Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Futures, Swaps, and Risk Management</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh23HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 23: Futures, Swaps, and Risk Management</span></div>
...
export default investingCh23HTML;
export { investingCh23Pages };
