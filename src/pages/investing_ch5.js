const investingCh5Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Risk, Return, and the Historical Record</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh5HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 5: Risk, Return, and the Historical Record</span></div>
...
export default investingCh5HTML;
export { investingCh5Pages };
