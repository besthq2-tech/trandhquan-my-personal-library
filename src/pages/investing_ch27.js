const investingCh27Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 The Theory of Active Portfolio Management</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh27HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 27: The Theory of Active Portfolio Management</span></div>
...
export default investingCh27HTML;
export { investingCh27Pages };
