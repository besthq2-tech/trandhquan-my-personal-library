const investingCh18Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Equity Valuation Models</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh18HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 18: Equity Valuation Models</span></div>
...
export default investingCh18HTML;
export { investingCh18Pages };
