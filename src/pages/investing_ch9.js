const investingCh9Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 The Capital Asset Pricing Model</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh9HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 9: The Capital Asset Pricing Model</span></div>
...
export default investingCh9HTML;
export { investingCh9Pages };
