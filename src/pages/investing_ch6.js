const investingCh6Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Capital Allocation to Risky Assets</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh6HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 6: Capital Allocation to Risky Assets</span></div>
...
export default investingCh6HTML;
export { investingCh6Pages };
