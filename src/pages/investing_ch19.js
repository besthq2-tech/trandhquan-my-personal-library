const investingCh19Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Financial Statement Analysis</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh19HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 19: Financial Statement Analysis</span></div>
...
export default investingCh19HTML;
export { investingCh19Pages };
