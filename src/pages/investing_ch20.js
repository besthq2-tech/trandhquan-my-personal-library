const investingCh20Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Options Markets: Introduction</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh20HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 20: Options Markets: Introduction</span></div>
...
export default investingCh20HTML;
export { investingCh20Pages };
