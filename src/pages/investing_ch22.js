const investingCh22Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Futures Markets</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh22HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 22: Futures Markets</span></div>
...
export default investingCh22HTML;
export { investingCh22Pages };
