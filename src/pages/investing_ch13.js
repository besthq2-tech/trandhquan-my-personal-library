const investingCh13Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Empirical Evidence on Security Returns</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh13HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 13: Empirical Evidence on Security Returns</span></div>
...
export default investingCh13HTML;
export { investingCh13Pages };
