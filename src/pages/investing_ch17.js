const investingCh17Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Macroeconomic and Industry Analysis</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh17HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 17: Macroeconomic and Industry Analysis</span></div>
...
export default investingCh17HTML;
export { investingCh17Pages };
