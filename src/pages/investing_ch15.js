const investingCh15Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 The Term Structure of Interest Rates</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh15HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 15: The Term Structure of Interest Rates</span></div>
...
export default investingCh15HTML;
export { investingCh15Pages };
