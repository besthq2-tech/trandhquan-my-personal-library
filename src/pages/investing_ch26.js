const investingCh26Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Hedge Funds</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh26HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 26: Hedge Funds</span></div>
...
export default investingCh26HTML;
export { investingCh26Pages };
