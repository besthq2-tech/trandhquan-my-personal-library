const investingCh8Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Index Models</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh8HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 8: Index Models</span></div>
...
export default investingCh8HTML;
export { investingCh8Pages };
