const investingCh21Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Option Valuation</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh21HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 21: Option Valuation</span></div>
...
export default investingCh21HTML;
export { investingCh21Pages };
