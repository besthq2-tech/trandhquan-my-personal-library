const investingCh16Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Managing Bond Portfolios</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh16HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 16: Managing Bond Portfolios</span></div>
...
export default investingCh16HTML;
export { investingCh16Pages };
