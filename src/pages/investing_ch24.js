const investingCh24Pages = [
`<div class="insight-box anim-trigger fade-left">
  <p><strong>📖 Portfolio Performance Evaluation</strong> đang trong quá trình xây dựng nội dung chi tiết. Hãy quay lại sau nhé!</p>
</div>`
];

const investingCh24HTML = `
<div class="article-wrap" style="display: block;">
  <div class="breadcrumb"><a href="#/home">Home</a> / <a href="#/investing">Investing</a> / <span>Chapter 24: Portfolio Performance Evaluation</span></div>
...
export default investingCh24HTML;
export { investingCh24Pages };
